...

      {
        ...
        fields: [{
          ...
          fields: [{
            ...
            label: "Jahr",
            widget: "number",
            pattern: ["^.{4}$", "Muss eine 4-stellige Zahl sein (zb.: 2020)"],
            ...
            options: ["Öffentlich", "Privat", "Universität", "Labor", "Büro", "Wohnbau", "Außenraum", "Ausstellungsraum", "Geschäft/Shop", "wohnen", "lernen", "arbeiten"]
          }]
        }, {
          name: "titleimg",
          widget: "object",
          ...
          fields: [ */
        {
          ...
          widget: "text",
          required: true,
          pattern: ["^.{10,160}$", "Zwischen 10 und maximal 160 Zeichen. Die Anzahl ist optimiert auf Suchmaschinen. Diese 160 Zeichen sollten möglichst alle wichtigen Projekteigentschaften enthalten."]
        }, {
          name: "body",
          label: "Langtext",
          widget: "markdown",
